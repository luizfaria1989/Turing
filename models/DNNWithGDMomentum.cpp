...
/**
 * @brief Implementa uma rede neural densa de duas camadas com a função tangente hiperbólica e
 * softmax como funções de ativação, entropia cruzada categórica como função de perda e
 * gradiente descendente com momento como otimizador da rede.
 */
int main() {
    ...
    GDMomentum optimizer(0.01f, 0.01f);
